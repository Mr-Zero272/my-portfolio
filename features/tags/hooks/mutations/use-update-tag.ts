...
import { UpdateTagRequest } from '../../types';

type UseUpdateTagOptions = Omit<UseMutationOptions<Tag, ApiError, UpdateTagRequest>, 'mutationFn'>;

export const useUpdateTag = (options?: UseUpdateTagOptions) => {
