    ...
    <section className="flex flex-col gap-5 lg:flex-row lg:gap-10">
      <article className="relative flex-1 p-5 lg:p-10">
        ...
        <p className="mb-10 text-gray-500">
          You can contact me through the form beside, I look forward to cooperating and working with
          you.
        </p>
        <ul className="space-y-3">
          <li>
            <Link
              ...
              className="group hover:border-primary flex cursor-pointer items-center gap-x-3 border-b pb-3"
            >
              ...
              <div>
                <p className="text-muted-foreground text-sm">Email me</p>
          ...
          <li>
            ...
            >
              ...
              <div>
                <p className="text-muted-foreground text-sm">My address</p>
