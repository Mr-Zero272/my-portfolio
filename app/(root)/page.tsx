    ...
    return (
      <section className="relative flex flex-col xl:flex-row">
        <div className="relative mb-7 flex flex-1 justify-evenly xl:mb-0 xl:w-5/12 xl:justify-center">
          ...
          />
          <Image
            className="hidden size-80 rounded-full object-cover object-top min-[500px]:size-96 min-[500px]:rounded-none xl:h-160 xl:w-120 dark:block dark:mix-blend-screen"
            src="/images/profile-home-dark.png"
            width={1000}
            height={1000}
            quality={100}
            priority
