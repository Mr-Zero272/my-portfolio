        ...
        <div className="flex-1 p-5">
          <div className="mb-8 flex justify-center p-2 sm:justify-around sm:p-0">
            <div className="relative mt-0 h-80 w-[22rem] sm:w-[30rem]">
              ...
              <div className="absolute right-0 bottom-0 z-0 h-[4rem] w-[19rem] bg-slate-200/30 sm:w-[26rem] dark:bg-card"></div>
              <div className="flex h-16 w-full items-end justify-between">
                <div className="flex h-[4rem] w-[3rem] items-center justify-center rounded-b-[4rem] bg-slate-200/30 sm:h-16 sm:w-16 dark:bg-card"></div>
