...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<'div'>(
      {
        className: cn(
          'text-sidebar-foreground/70 ring-sidebar-ring outline-hidden [&>svg]:size-4 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:hidden group-data-[collapsible=icon]:opacity-100 [&>svg]:shrink-0',
          className,
        ),
      },
      props,
