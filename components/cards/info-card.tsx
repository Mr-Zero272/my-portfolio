    ...
    return (
        <div className={`h-40 w-40 sm:w-44 ${className}`}>
            <div className="relative flex items-center justify-between">
                <div className="flex h-16 flex-1 items-center justify-center overflow-hidden rounded-t-3xl bg-background p-4 text-lg sm:text-2xl">
                    {title}
                </div>
                {arrow ? (
                    <>
                        <div className="absolute right-0 top-0 size-16 bg-background"></div>
            ...
            <div className="flex h-[6rem] w-full items-center justify-between gap-x-2 rounded-b-3xl rounded-tr-3xl bg-background p-4">
