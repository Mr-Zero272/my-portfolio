      ...
      >
        ...
        <div className="border-border border-t px-3 pt-2 pb-3">
          <div className="flex items-center gap-2">
            <Checkbox
              id="datetime-include-time"
              checked={includeTime}
              onCheckedChange={handleCheckboxChange}
            />
            <Label
              htmlFor="datetime-include-time"
            ...
            >
              <input
                ...
                className={cn(
                  'border-input bg-background rounded border px-2 py-0.5 text-sm',
                  'focus:ring-ring focus:ring-2 focus:ring-offset-1 focus:outline-none',
                  'disabled:cursor-not-allowed disabled:opacity-50',
                  'transition-opacity duration-150',
                )}
              />
              <span className="text-muted-foreground truncate text-xs">{userTimeZone}</span>
            </Label>
          </div>
        </div>
      </PopoverContent>
